...
export function Hero({
    ...
    return (
        <section className="relative w-full min-h-screen overflow-hidden">
            ...
            <Container>
                <div className="relative flex flex-col justify-center min-h-screen py-24 sm:py-32">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        {/* Headline */}
                        <h1 className="mt-6 mx-auto max-w-3xl text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-tight">
                            {title}
                        </h1>

                        {/* Subtitle */}
                        <p className="mt-5 mx-auto max-w-2xl text-base text-blue-100 leading-relaxed">
                            {subtitle}
                        </p>
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
                            <Button
                                ...
                                className="!bg-white !text-blue-700 hover:!bg-blue-50 !rounded-lg !px-6 !py-2.5 !font-semibold"
                            >
                                {primaryCta.label}
                            </Button>
                            <Button
                                ...
                                variant="secondary"
                                className="!bg-white/10 !text-white !border-white/20 hover:!bg-white/20 !rounded-lg !px-6 !py-2.5"
                            >
                                {secondaryCta.label}
                            </Button>
                        </div>
                    ...
                    {/* Stats cards */}
                    <div className="mx-auto mt-16 w-full max-w-4xl grid gap-4 sm:grid-cols-3">
                        {[
